...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "부모님 생신, 명절, 건강검진, 가족 모임까지. Familit이 가족이 함께 챙겨야 할 일을 카드로 정리하고, 체크리스트로 나누고, 함께 확인하며 완료하게 돕습니다." },
      { name: "author", content: "Familit" },
      { property: "og:title", content: "Familit — 가족 케어 운영 앱" },
      { property: "og:description", content: "놓치기 쉬운 가족 일을 가족 액션 카드로 정리하세요. 베타 신청 받는 중." },
